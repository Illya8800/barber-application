...
import static com.barber.hopak.model.enumeration.ImageExtensions.largestExtensionLengthWithDot;
...
public class OriginalFileNameNotBlankValidator implements ConstraintValidator<OriginalFileNameNotBlank, MultipartFile> {
    ...
    public boolean isValid(MultipartFile value, ConstraintValidatorContext context) {
        ...
        return originalFilename != null && originalFilename.trim().length() > largestExtensionLengthWithDot();
    }
}
